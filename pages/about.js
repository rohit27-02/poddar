...
const About = () => {
  return (
    <div className='text-gray-600 drop-shadow-sm'>
      ...
      <div className='flex flex-col gap-[2rem] mx-[20rem] text-justify my-[3rem]'>
      ...
      <div className='py-[2rem]  bg-orange-50'>
        ...
        <div className='flex justify-center gap-[4rem] my-[5rem]'>
          <div className='flex w-1/4 flex-col text-justify gap-[1rem]'>
