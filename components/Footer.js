      ...
      <div className="container px-5 py-16 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
        <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
          <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
            <img src='/logo.png' className='h-[10vh] md:h-[15vh]' alt='logo' />
          </a>
        ...
        <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
          ...
          <div className="lg:w-1/3 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              <li>
                <a href='/Privacy Policy.pdf' className="cursor-pointer drop-shadow text-gray-600 hover:text-gray-800">PRIVACY POLICY</a>
              </li>
            </nav>
          </div>
          <div className="lg:w-1/3 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none space-y-4 mb-10">
              ...
              <li>
                <a className="cursor-pointer drop-shadow text-gray-600 hover:text-gray-800">poddarayurvedicpharmacy@gmail.com</a>
              </li>
            </nav>
          </div>
      ...
      <div>
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          ...
          <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
            ...
            <a href='https://www.instagram.com/poddarchurans/?igshid=NTc4MTIwNjQ2YQ%3D%3D' className="ml-3 text-gray-500">
              <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
                <rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect>
                <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01"></path>
              </svg>
            </a>
            <a target='_blank' href='https://www.linkedin.com/company/poddar-ayurvedic-pharmacy/' className="ml-3 text-gray-500">
